...
/*
	CHANGES MADE ON 06/27/2014 by Nathaniel Inman : "IE 7-9 support"
	
	Added var scripts - comments located below
	Modified the entire loading mechanism to utilize the scripts variable
		and allow support for older IE using local storage space. Furthermore,
		it wasn't waiting until the scripts were completely loaded as it was
		pushing them into src variable
	Pulled the script tag scraper out of the compiler and ran it in an anonymous
		function to initiate the loading of the content before firing the compiler
	Slightly moved the contents of the compile function to make more
		sense after modifying it.	
	
	CHANGES MADE ON 07/02/2014 by Nathaniel Inman : "Runs latest TypeScript Versions"
	
	Added ScriptSnapshot, getSyntacticDiagnostics, and other new compilation
		requirement methods for TypeScript
*/
(function() {
