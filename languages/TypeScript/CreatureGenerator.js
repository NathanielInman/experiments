...
/* The main class */
var CreatureGenerator = (function () {
    function CreatureGenerator(list) {
        var _this = this;
        this.creature = [];
        this.deserialize(list);
        easel.redraw = function () { return _this.draw(); };
    }
    CreatureGenerator.prototype.deserialize = function (list) {
        for (creature in list) {
            this.creature.push(new Entry().deserialize(list[creature]));
        }
        this.update();
    };
    CreatureGenerator.prototype.draw = function () {
    ...
    CreatureGenerator.prototype.update = function () {
        var _this = this;
