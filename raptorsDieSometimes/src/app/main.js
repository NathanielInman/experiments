var bgColor=0,
    ...
    survived=0,
    destroyed=0,
    filmEngine={cur: 0, dir: 1, color: '#f66'},
    cloud=[],
    snow=[],
    curAvg=0,
    map=[],
    ...
    moonbg1=document.getElementById('moonbg1'),
    moonbg2=document.getElementById('moonbg2'),
    moonbg3=document.getElementById('moonbg3'),
    scoreDestroyedDiv=document.getElementById('scoreDestroyed'),
    scoreSurvivedDiv=document.getElementById('scoreSurvived');
...
function changeTOD(){
  ...
  BGC=`rgb(${Math.floor(bgColor*0.6)},${Math.floor(bgColor*0.8)},${bgColor})`;
...
function prepTheWorld(){
  for(let i=0;i<100;i++) moveClouds(true);
} //end prepTheWorld()
...
export function main(){
  setInterval(runBuild,10);
  setInterval(killSnow,100);
  setInterval(changeTOD,10);
  setInterval(moveClouds,500);
  setInterval(processAnimal,100);
  setInterval(adjustScore,500);
} //end main()
